...
public:
    ...
    /**
        Register handler to listen implementation required EventTypes.
        All child class in a EventHandler class hierachery must call it's parent RegisterEventListner() method.
    */
    virtual void registerEventListener(void);
    /**
        Deregister handler from listening to implementation required EventTypes.
        All child class in a EventHandler class hierachery must call it's parent deregisterEventListener() method.
    */
