...
inline const double Time::asSeconds(void) const
{
    return static_cast<double>(m_TimeInMicroseconds)/1000000.0;
}

inline const std::int32_t Time::asMilliseconds(void) const
{
    return static_cast<std::int32_t>(m_TimeInMicroseconds/1000);
}

inline const std::int64_t Time::asMicroseconds(void) const
{
...
inline ke::Time Time::milliseconds(const std::int32_t p_Amount)
{
